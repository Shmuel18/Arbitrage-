...
Write-Host "⚠️  WARNING: This will delete ALL trade history, PnL data, and logs." -ForegroundColor Yellow
...
Write-Host "`n✨ System Reset Complete! You can now start the bot fresh." -ForegroundColor Green
