...
def config():
    ...
    return Config(
        ...
        trading_params=TradingParams(
            min_net_bps=Decimal("5.0"),
            slippage_buffer_bps=Decimal("2.0"),
            safety_buffer_bps=Decimal("3.0"),
            basis_buffer_bps=Decimal("1.0"),
        ),
...
def sample_opportunity():
    return OpportunityCandidate(
        ...
        gross_edge_bps=Decimal("12.0"),
        fees_bps=Decimal("2.0"),
        net_edge_bps=Decimal("7.0"),
