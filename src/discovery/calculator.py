...
class WorstCaseCalculator:
    ...
    def calculate_funding_edge(
        ...
        """
        Calculate funding rate edge in bps
        
        Args:
            funding_rate_long: Funding rate on long side (receive)
            funding_rate_short: Funding rate on short side (pay)
            funding_hours: Hours between fundings
        
        Returns:
            Net funding edge in basis points
        """
        # Net funding per period
        net_funding = funding_rate_short - funding_rate_long
    ...
    def calculate_net_profit(
        ...
        funding_edge = self.calculate_funding_edge(
            funding_rate_long,
            funding_rate_short,
            funding_hours=spec_long.funding_interval_hours
        )
